    ...
    <div className="w-full max-w-3xl mx-auto px-4 md:px-6 pb-[calc(max(env(safe-area-inset-bottom),24px))] md:pb-8">
      <div className="relative flex items-end bg-zinc-200 dark:bg-zinc-800/60 rounded-[28px] p-2 transition-all focus-within:bg-zinc-200/50 dark:focus-within:bg-zinc-800 focus-within:ring-2 focus-within:ring-primary/20">
        <textarea
          ...
          rows={1}
          className="w-full bg-transparent text-foreground placeholder:text-muted resize-none pl-6 pr-2 py-4 max-h-[200px] outline-none border-none focus:ring-0 text-[16px] leading-relaxed disabled:opacity-50 scrollbar-thin scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-700"
        />
        ...
        <div className="p-2 shrink-0">
          <motion.button
            ...
            className={`flex items-center justify-center w-10 h-10 rounded-full transition-all ${content.trim() && !isStreaming
